...
public class GuiNim extends JFrame {
	 ...
	 */
	private static final long serialVersionUID = -7620520052830475164L;
	...
	public GuiNim(String title) {
		...
		//NimPanel2 app = new NimPanel2(frame, cont);
		//app.init(cont);
		...
		cont.add(new NimPanel2(frame), BorderLayout.CENTER);
		frame.pack(); // Pack all components to their preferred sizes.
