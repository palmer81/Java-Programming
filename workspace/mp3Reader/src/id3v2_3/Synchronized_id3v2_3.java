...
/**
 * The Class Synchronized_id3v2_3.
 */
public class Synchronized_id3v2_3 extends ByteHelper {
    ...
    */
   public Synchronized_id3v2_3(File file) throws IOException,
   ...
   public boolean hasExtHeader() throws FileNotFoundException, IOException {
      ...
      if(flag == (byte) 64 || flag == (byte) 96 || flag == (byte) 192
         || flag == (byte) 224) return true;
      return false;
   }
