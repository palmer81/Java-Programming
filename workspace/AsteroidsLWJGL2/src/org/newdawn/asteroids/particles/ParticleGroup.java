...
public class ParticleGroup {
	...
	private int fadeOut;
	/** The red component of the color of each particle */
	private float r;
	/** The green component of the color of each particle */
	private float g;
	/** The blue component of the color of each particle */
	private float b;
	 ...
	 * @param r The red component of the color of each particle
	 * @param g The green component of the color of each particle
	 * @param b The blue component of the color of each particle
	 */
	...
	public void update(int delta) {
		// cycle through every particle, aging it. If the particle
